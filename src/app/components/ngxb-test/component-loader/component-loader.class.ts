  ...
  private _getContentRef(content: string | TemplateRef<any> | any, context?: any): ContentRef {
    ...
    if (content instanceof TemplateRef) {
      if (this._viewContainerRef) {
        const viewRef2 = this._viewContainerRef.createEmbeddedView<TemplateRef<T>>(content, context);
        viewRef2.markForCheck();
        return new ContentRef([viewRef2.rootNodes], viewRef2);
      }
